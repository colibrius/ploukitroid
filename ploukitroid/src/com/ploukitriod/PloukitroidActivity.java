...
public class PloukitroidActivity extends Activity implements SensorEventListener
{
	...
	public void onSensorChanged(SensorEvent event)
	{
		...
		if (axisX > 1)
		{
			layoutRect.getRectangle().set(layoutRect.getRectangle().left - 1, layoutRect.getRectangle().top, layoutRect.getRectangle().right - 1, layoutRect.getRectangle().bottom);
